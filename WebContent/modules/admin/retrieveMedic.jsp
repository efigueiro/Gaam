    	...
    	<div class="row">
    		<div class="col-md-12">
    			<div class="panel panel-default">
  					<div class="panel-heading"><%=Msg.getProperty("title.searchMedic")%></div>
  					<div class="panel-body">
  						<form role="form" action="/Gaam/retrieveMedic" method="post">
  					...
  					<div class="panel-body">
  						...
  						<table class="table table-hover">
  							<tr>
								...
								<th class="header"><%=Msg.getProperty("label.insuranceCompany")%></th>
  		...
  		<div class="modal-dialog">
  			<div class="modal-content">
        		...
        		<div class="modal-body">
        			<form action="/Gaam/deleteMedic" method="post">
        				${message}
          				<div class="form-group">
